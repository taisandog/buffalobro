...
{
    public partial class UICOS : UIConnBase
    {
        public UICOS()
        {
            InitializeComponent();
        ...
        protected override void OnTest()
        {
            ...
            IFileStorage storage = FSCreater.Create("QCloud", sbStr);
            try
            {
                storage.Open();
        ...
        protected override void OnConnOut()
        {
            ...
            sbCode.Append("\";");
            sbCode.AppendLine("");
            sbCode.Append("IFileStorage storage = FSCreater.Create(\"COS\", sconnStr);");
            sbCode.AppendLine("");
