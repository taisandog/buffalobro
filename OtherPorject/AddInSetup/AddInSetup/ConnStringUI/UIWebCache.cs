...
{
    public partial class UIWebCache  : UIConnBase
    {
        public UIWebCache()
        {
            InitializeComponent();
        ...
        protected override void OnTest()
        {
            ...
            try
            {
                QueryCache cache = CacheUnit.CreateCache(BuffaloCacheTypes.Web, sbStr);
        ...
        protected override void OnConnOut()
        {
            ...
            sbCode.Append("\";");
            sbCode.AppendLine("");
            sbCode.Append(" QueryCache cache = CacheUnit.CreateCache(BuffaloCacheTypes.Web, connString);");
