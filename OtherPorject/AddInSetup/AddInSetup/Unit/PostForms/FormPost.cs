...
namespace Buffalo.WebKernel.WebCommons.PostForms
{
    ...
    public class FormPost
    {
        ...
        public static HttpWebRequest CreateHttpWebRequest(string actionUrl) 
        {
            HttpWebRequest request = null;

            if (actionUrl.StartsWith("https", StringComparison.OrdinalIgnoreCase))
            {
                ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(CheckValidationResult);
                request = WebRequest.Create(actionUrl) as HttpWebRequest;
        ...
        /// <returns></returns>
        public String PostData(String actionUrl, IEnumerable<KeyValuePair<string, string>> prms, IEnumerable<FormFile> files)
        {
            HttpWebRequest request = CreateHttpWebRequest(actionUrl);
        ...
        /// <param name="files">要发送的文件</param>
        /// <returns></returns>
        public String Post(String actionUrl, IDictionary<string, string> prms)
        {


            using (StreamReader reader = PostDataReader(actionUrl, prms, null))
        ...
        /// <param name="files">要发送的文件</param>
        /// <returns></returns>
        public static void PostData(HttpWebRequest request, PostHead head, IEnumerable<KeyValuePair<string, string>> prms, IEnumerable<FormFile> files)
        {
        ...
        public String GetData(String actionUrl)
        {
            ...
            using (HttpWebResponse rep = CreateGetHttpResponse(actionUrl, RequestHead))
            {
        ...
        /// <returns></returns>
        public static StreamReader GetStreamReader(HttpWebResponse rep, Encoding encoding)
        {
