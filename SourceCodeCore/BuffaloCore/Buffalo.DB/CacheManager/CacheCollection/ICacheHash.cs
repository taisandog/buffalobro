...
namespace Buffalo.DB.CacheManager.CacheCollection
{
    ...
    public interface ICacheHash
    {
        ...
        /// <param name="dicSet">值</param>
        /// <returns></returns>
        Task SetRangeValueAsync(IDictionary<string, object> dicSet);
        /// <summary>
        /// HashSet设置值
        /// </summary>
        /// <param name="key">哈希表的键</param>
        /// <param name="value">哈希表的值</param>
        /// <param name="type">设置方式</param>
        Task<bool> SetValueAsync(string key, object value, SetValueType type = SetValueType.Set);
        /// <summary>
        /// 获取哈希表的值
        /// </summary>
        /// <typeparam name="E"></typeparam>
        ...
        /// <param name="oper"></param>
        /// <returns></returns>
        Task<E> GetValueAsync<E>(string key, E defaultValue = default(E));
        /// <summary>
        /// 获取所有哈希表的值
        /// </summary>
        /// <typeparam name="E"></typeparam>
        ...
        /// <param name="oper"></param>
        /// <returns></returns>
        Task<List<KeyValuePair<string, V>>> GetAllValuesAsync<V>(V defaultValue);
        /// <summary>
        /// 获取所有哈希表的键
        /// </summary>
        /// <typeparam name="E"></typeparam>
        /// <param name="oper"></param>
        /// <returns></returns>
        Task<ICollection<string>> GetAllKeysAsync();
        /// <summary>
        /// 删除哈希表的值
        /// </summary>
        /// <typeparam name="E"></typeparam>
        ...
        /// <param name="oper"></param>
        /// <returns></returns>
        Task<long> DeleteValuesAsync(IEnumerable<string> keys);
