...
namespace Buffalo.DB.CacheManager.CacheCollection
{
    ...
    public interface ICacheList
    {
        ...
        /// <param name="setType">设置值方式</param>
        /// <returns></returns>
        Task<long> AddValueAsync(object value, long index = -1, SetValueType setType = SetValueType.Set);
        ...
        /// <param name="setType">设置值方式</param>
        /// <returns></returns>
        Task<long> AddRangValueAsync(IEnumerable values, long index = -1, SetValueType setType = SetValueType.Set);
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns></returns>
        Task<E> GetValueAsync<E>(long index, E defaultValue = default(E));
        ...
        /// <param name="count">要移除几个，0则为全部移除</param>
        /// <returns></returns>
        Task<long> RemoveValueAsync(object value, long count = 0);
        ...
        /// <param name="end">结束位置(-1则为读到末尾)</param>
        /// <returns></returns>
        Task<List<E>> AllValuesAsync<E>(long start = 0, long end = -1);
        ...
        /// <param name="value">要插入的值</param>
        /// <returns></returns>
        Task<long> InsertAfterAsync(object pivot, object value);
        /// <summary>
        /// 加入到这个值的前边
        /// </summary>
        /// <param name="pivot">后一个值</param>
        /// <param name="value">要插入的值</param>
        /// <returns></returns>
        Task<long> InsertBeforeAsync(object pivot, object value);
        /// <summary>
        /// 移除一个元素并返回
        /// </summary>
        /// <typeparam name="E"></typeparam>
        ...
        /// <param name="defaultValue">没元素时候的默认值</param>
        /// <returns></returns>
        Task<E> PopValueAsync<E>(bool isPopEnd = false, E defaultValue = default(E));
    }
}
