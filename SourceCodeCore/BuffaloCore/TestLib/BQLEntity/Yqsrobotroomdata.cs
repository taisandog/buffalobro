...
namespace TestLib.BQLEntity
{
    ...
    {
        private static BQL_Yqsrobotroomdata _Yqsrobotroomdata = new BQL_Yqsrobotroomdata();
    
        public static BQL_Yqsrobotroomdata Yqsrobotroomdata
        {
            get
            {
                return _Yqsrobotroomdata;
            }
        }
    }
    ...
    ///  
    /// </summary>
    public partial class BQL_Yqsrobotroomdata : TestLib.BQLEntity.BQL_YMRBase
    {
        ...
        public BQL_Yqsrobotroomdata(BQLEntityTableHandle parent,string propertyName) 
        :this(typeof(TestLib.Yqsrobotroomdata),parent,propertyName)
        {
        ...
        /// <param name="parent">父表信息</param>
        /// <param name="propertyName">属性名</param>
        public BQL_Yqsrobotroomdata(Type entityType,BQLEntityTableHandle parent,string propertyName) 
