...
namespace TestLib.BQLEntity
{
    ...
    {
        private static BQL_Ymrrobotconfig _Ymrrobotconfig = new BQL_Ymrrobotconfig();
    
        public static BQL_Ymrrobotconfig Ymrrobotconfig
        {
            get
            {
                return _Ymrrobotconfig;
            }
        }
    }
    ...
    ///  
    /// </summary>
    public partial class BQL_Ymrrobotconfig : TestLib.BQLEntity.BQL_YMRBase
    {
        ...
        public BQL_Ymrrobotconfig(BQLEntityTableHandle parent,string propertyName) 
        :this(typeof(TestLib.Ymrrobotconfig),parent,propertyName)
        {
        ...
        /// <param name="parent">父表信息</param>
        /// <param name="propertyName">属性名</param>
        public BQL_Ymrrobotconfig(Type entityType,BQLEntityTableHandle parent,string propertyName) 
