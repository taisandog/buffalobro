...
namespace Aliyun.OSS
{
    ...
    public class OssClient : IOss
    {
        ...
        {
            if (endpoint == null)
                throw new ArgumentException(Resource.ExceptionIfArgumentStringIsNullOrEmpty, "endpoint");
            ...
            if (credsProvider == null)
                throw new ArgumentException(Resource.ExceptionIfArgumentStringIsNullOrEmpty, "credsProvider");
