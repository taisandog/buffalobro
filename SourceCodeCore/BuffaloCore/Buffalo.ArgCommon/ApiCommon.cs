...
namespace Buffalo.ArgCommon
{
    ...
    public class ApiCommon
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static APIResault GetSuccess(string message, object data)
        {
            APIResault res = new APIResault();
            res.SetSuccess(message, data);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static APIResault GetSuccess()
        {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static APIResault GetFault(string message,object data)
        {
            APIResault res = new APIResault();
            res.SetFault(message, data);
            return res;
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static APIResault GetFault(string message)
        {
            return GetFault(message,null);
        }
#endif
