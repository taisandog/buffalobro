//------------------------------------------------------------------------------
// <copyright file="BuffaloToolCDCommand.cs" company="Company">
...
namespace Buffalo2015.DBToolsPackage
{
    ...
    /// Command handler
    /// </summary>
    public class BuffaloToolCDCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        //static CommandItems _commitem = new CommandItems();
        ...
        private BuffaloToolCDCommand(Package package)
        {
            if (package == null)
            {
            ...
            if (commandService != null)
            {
                for (int i = 0; i < CommandIds.Length; i++)
                {
                    ...
                    var menuCommandID = new CommandID(CommandSet, item);
                ...
                for (int i = 0; i < CommandClassIds.Length; i++)
                {
                    ...
                    var menuCommandID = new CommandID(CommandSet2, item);
                    var menuItem = new MenuCommand(this.MenuItemCallback, menuCommandID);
                    commandService.AddCommand(menuItem);
        ...
        private System.IServiceProvider ServiceProvider
        {
            get
            {
                return this._package as IServiceProvider;
            }
        }
        ...
        {
            Instance = new BuffaloToolCDCommand(package);
