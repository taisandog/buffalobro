...
namespace DBTools
{
    ...
    public sealed class BuffaloToolCDCommand
    {
        ...
        public SelectedShapesCollection SelectedShapes
        {
            get
            {
                ClassDesignerDocView docView = GetSelectDocView();
                if (docView == null)
                {
                    return null;
                }
        ...
        {
            ClassDesignerDocView doc = GetSelectDocView();
            ClassDesignerInfo designerInfo = new ClassDesignerInfo(SelectedDiagram, CurrentProject, doc);
            return designerInfo;
        }
        ...
        /// 选中的文档视图
        /// </summary>
        public ClassDesignerDocView GetSelectDocView()
        {

            ISelectionContainer selectionContainer;
            IVsMonitorSelection monitorService = _serviceProvider.GetService(typeof(IVsMonitorSelection)) as IVsMonitorSelection;
            if (monitorService != null)
            {
                ...
                if (ppSC != IntPtr.Zero)
                {
                    selectionContainer = Marshal.GetObjectForIUnknown(ppSC) as ISelectionContainer;
                    ISelectionService SelectionContainer = selectionContainer as ISelectionService;
                    ClassDesignerDocView doc = (ClassDesignerDocView)selectionContainer ;
            ...
            try
            {
                ...
                else if (cmd.CommandID.ID == 0x1040)//显示隐藏注释
                {
                    ...
                    if (dia != null)
                    {
                        ...
                        this.GetSelectDocView().CurrentDesigner.ScrollDown();
                        this.GetSelectDocView().CurrentDesigner.ScrollUp();
                    }
                }
