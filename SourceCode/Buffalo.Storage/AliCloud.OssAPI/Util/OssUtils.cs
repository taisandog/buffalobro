...
namespace Aliyun.OSS.Util
{
    ...
    public static class OssUtils
    {
        ...
        {
            if (string.IsNullOrEmpty(bucketName))
                throw new ArgumentException(Resource.ExceptionIfArgumentStringIsNullOrEmpty, "bucketName");
        ...
        internal static void CheckCredentials(string accessKeyId, string accessKeySecret)
        {
            if (string.IsNullOrEmpty(accessKeyId))
                throw new ArgumentException(Resource.ExceptionIfArgumentStringIsNullOrEmpty, "accessKeyId");
            if (string.IsNullOrEmpty(accessKeySecret))
                throw new ArgumentException(Resource.ExceptionIfArgumentStringIsNullOrEmpty, "accessKeySecret");
        }
